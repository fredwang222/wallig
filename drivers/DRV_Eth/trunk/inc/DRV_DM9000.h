 ...
 * 2010-08-14     Gwend Le Gall Updates for Wallig compatibility
 */
...
#define    DM9000_IO 	(*((volatile uint16_t *) 0x6C100000)) // CMD = 0
#define    DM9000_DATA 	(*((volatile uint16_t *) 0x6C100008)) // CMD = 1

#define DM9000_inb(r) 		(*(volatile unsigned char *)r)
#define DM9000_outb(r, d) 	(*(volatile unsigned char *)r = (unsigned char)d)
#define DM9000_inw(r) 		(*(volatile uint16_t *)r)
#define DM9000_outw(r, d) 	(*(volatile uint16_t *)r = (uint16_t)d)
