...
export SYS_INCLUDE = -I $(SYSTEM_PATH) -I $(SYSTEM_PATH)/inc_f2 -I $(STM32LIB_PATH) -I $(STM32LIB_PATH)/inc -I $(CMSIS_PATH)/DeviceSupport/ST/STM32F2xx -I $(CMSIS_PATH)/CoreSupport/ -I $(CONFIG_PATH)
export CC=arm-none-eabi-gcc 
export CFLAGS= -mthumb $(ARCH_DEFINE)  -mcpu=cortex-m3 -mfix-cortex-m3-ldrd -O0 -g3 -DUSE_STDPERIPH_DRIVER -Wall -MMD -MP -MF$(patsubst %.o,%.d,$@) -MT$(patsubst %.o,%.d,$@) -Wa,-adhlns=$(patsubst %.o,%.lst,$@) $(SYS_INCLUDE) 
