...
export CFLAGS=-DARCH_STM32  -mthumb $(ARCH_DEFINE)  -mcpu=cortex-m3 -mfix-cortex-m3-ldrd -O0 -g3  -Wall -MMD -MP -MF$(patsubst %.o,%.d,$@) -MT$(patsubst %.o,%.d,$@) -Wa,-adhlns=$(patsubst %.o,%.lst,$@) $(SYS_INCLUDE)
