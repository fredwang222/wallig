...
export CFLAGS= -mthumb $(ARCH_DEFINE) -D$(CPU_DENSITY) -mcpu=cortex-m3 -mfix-cortex-m3-ldrd -O0 -g3 -DUSE_STDPERIPH_DRIVER -Wall -MMD -MP -MF$(patsubst %.o,%.d,$@) -MT$(patsubst %.o,%.d,$@) -Wa,-adhlns=$(patsubst %.o,%.lst,$@) $(SYS_INCLUDE) 
